...
export function ExternalDropBlocker({ onUploadClick }: { onUploadClick: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center pointer-events-none">
            <div className="glass bg-brand-surface border border-brand-border rounded-2xl p-8 max-w-md mx-4 shadow-2xl pointer-events-auto">
                <div className="flex flex-col items-center text-center gap-4">
                    ...
                    <button
                        ...
                        className="mt-2 px-6 py-2 bg-brand-primary text-white rounded-lg font-medium hover:bg-brand-primary/90 transition-colors"
                    >
                        Open Upload Dialog
                    </button>
                </div>
